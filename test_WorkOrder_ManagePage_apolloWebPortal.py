...
def WorkOrder_ManagePage (driver, driver_Name, driver_Version, carrier, truckDriversList, driver_UserName_Var, client_Name_Var, client_Adress_Var, defect_Vehicle_List_Var, workOrder_CreatedBy_Var, workOrder_Contacts_Var):
    ...
    calendar_Month_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[1]/ngb-datepicker-navigation/ngb-datepicker-navigation-select/select[1]"
    ...
    calendar_Year_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[1]/ngb-datepicker-navigation/ngb-datepicker-navigation-select/select[2]"
    ...
    calendar_DayStart_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[2]/div[1]/ngb-datepicker-month/div[2]"
...
#       Title of the right page
    ...
    print(date_now)
    print(calendar_Month_WorkOrderPageVar)
    print(calendar_Year_WorkOrderPageVar)
    ...
    try:
        calendar_Line7_Colum1_WorkOrderPageAdr = "/html/body/app-root/app-main/div/div/app-manageworkorder/section/div/app-search-panel/div/div/form/div[1]/div[4]/app-date-rangepicker/div/div/ngb-datepicker/div[2]/div[1]/ngb-datepicker-month/div[7]"
