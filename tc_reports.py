...
def write_reportfile_Header (control_Reportfile, print_Information_Fix, print_Information_Var, test_Case_Type, driver_Name, driver_Version, title_apollo_Portal_Version):
    ...
    if control_Reportfile == 0:
        ...
        print('*************************************************************************\n', file=TCReport)
        print(f'apollo Portal Version:  {title_apollo_Portal_Version}\n', file=TCReport)
